...
- Read `$ARGUMENTS/.omakase/prompts/app_spec.txt`
...
Start by reading the app specification file at `$ARGUMENTS/.omakase/prompts/app_spec.txt`, then greet the user with a summary of their existing project and ask what they want to add.

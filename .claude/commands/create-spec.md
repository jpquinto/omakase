...
**Output location:** `$ARGUMENTS/.omakase/prompts/app_spec.txt` and `$ARGUMENTS/.omakase/prompts/initializer_prompt.md`
...
The output directory is: `$ARGUMENTS/.omakase/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `$ARGUMENTS/.omakase/prompts/app_spec.txt`
...
**Output path:** `$ARGUMENTS/.omakase/prompts/initializer_prompt.md`
...
**Output path:** `$ARGUMENTS/.omakase/prompts/.spec_status.json`
...
```json
{
  ...
  "files_written": [
    ".omakase/prompts/app_spec.txt",
    ".omakase/prompts/initializer_prompt.md"
  ],
...
```json
{
  ...
  "files_written": [
    ".omakase/prompts/app_spec.txt",
    ".omakase/prompts/initializer_prompt.md",
    ".omakase/prompts/coding_prompt.md"
  ],
  "feature_count": 35
}
```
...
> "Your specification files have been created in `$ARGUMENTS/.omakase/prompts/`!
>
> **Files created:**
> - `$ARGUMENTS/.omakase/prompts/app_spec.txt`
> - `$ARGUMENTS/.omakase/prompts/initializer_prompt.md`
>
